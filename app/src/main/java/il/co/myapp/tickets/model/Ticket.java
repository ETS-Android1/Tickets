...
/**
 * Ticket Class contains all ticket members.
 * Converts input string date into appropriate Date Format
 * Converts input string date and time into appropriate date and time format.
 */
public class Ticket {
    ...
    /**
     * This method is used by the TicketAdapter for the TicketHistoryList */
    ...
    public Ticket(String driverName, String carNumber, String ticketNumber, String ticketDate,
        ...
        // This will be a HashMap of Date and Time Grouped By Date & Time format.
